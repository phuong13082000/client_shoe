...
import {HomeIcon, ShoppingCartIcon, HeartIcon} from "@heroicons/react/24/solid";
...
export const Navbar = () => {
    const {currentUser, setCurrentUser} = useContext<AuthContextType>(AuthContext);
                    ...
                    {currentUser &&
                        <>
                            ...
                            <li className="relative mt-6 md:mt-0 w-fit" onClick={handleSidebar}>
                                ...
                                {cartItems.length > 0 &&
                                    <span
                                        className="absolute -top-4 -right-3 bg-red-400 text-lg rounded-full w-[20px] h-[20px] text-white grid place-items-center">{cartItems.length}</span>
                                }
                            </li>
                        </>
                    }
